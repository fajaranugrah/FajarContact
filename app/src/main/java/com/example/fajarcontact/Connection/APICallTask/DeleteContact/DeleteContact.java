package com.example.fajarcontact.Connection.APICallTask.DeleteContact;
...
public abstract class DeleteContact extends ApiCalling {
    ...
    public DeleteContact(Activity activity) {
        super(activity);
