package com.example.fajarcontact.Connection.APICallTask.AddContact;
...
public abstract class AddContact extends ApiCalling {
    ...
    public AddContact(Activity activity) {
        super(activity);
